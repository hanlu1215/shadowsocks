...
或是前往 [客户中心](https://portal.shadowsocks.ch/index.php?rp=/download/category/1/Shadowsocks-.html) 下载
...
* 如果使用 PAC 模式无法访问网站，请点击 [Pac文件下载](https://portal.shadowsocks.ch/dl.php?type=d&id=14) 下载 pac 配置文件，将  `pac.txt` 文件拖放在与 `Shadowsocks.exe` 相同的文件目录下。
