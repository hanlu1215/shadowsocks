...
|:--------:|:--------:|
|[SwitchOmega + GFWList 自动切换配置文件(1080)](https://secure.shadowsocks.ch/dl.php?type=d&id=74)|[SwitchOmega + GFWList 自动切换配置文件(1086)](https://secure.shadowsocks.ch/dl.php?type=d&id=75)|
