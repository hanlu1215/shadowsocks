...
* If you cannot access the website using the PAC mode, click [here](https://order.shadowsocks.se/dl.php?type=d&id=14) to download the "pac configuration file" and drag `pac.txt` in the same directory as `Shadowsocks.exe`.
