...
|:--------:|:--------:|
|[SwitchOmega + GFWList 自动切换配置文件(1080)](https://order.shadowsocks.website/dl.php?type=d&id=74)|[SwitchOmega + GFWList 自动切换配置文件(1086)](https://order.shadowsocks.website/dl.php?type=d&id=75)|
