# 如何使用我们的[网站](https://order.shadowsocks.ch)
...
## 版本区别
||[入门版](https://order.shadowsocks.ch/cart.php?a=add&pid=33)|[高级版](https://order.shadowsocks.ch/cart.php?a=add&pid=36)|[旗舰版](https://order.shadowsocks.ch/cart.php?a=add&pid=34)|[IPv6 版本](https://order.shadowsocks.ch/cart.php?a=add&pid=17)|[企业版](https://order.shadowsocks.ch/cart.php?a=add&pid=9)|  
|:-:|:-:|:-:|:-:|:-:|:-:|
|价格（年付）|19.95 澳元|79.95 澳元|99.95澳元|19.95澳元|2999.95 / 4999.95澳元|
|价格（月付）|×|×|12.95澳元|×|299.95 / 499.95澳元|
|服务器数量¹|12|15|17|10|定制|
|普通綫路|〇|〇|〇|〇||
|高级綫路|×|〇|〇|×||
|中转綫路|×|×|〇|×||
|在綫设备数量|1|5|5|5|无限制|
...
* 打开 [https://shadowsocks.ch/](https://shadowsocks.ch/)并点击 [Order Now](https://order.shadowsocks.ch/link.php?id=5)，即可查看我们的产品列表。  
...
## 登陆账户
#### 登陆 [客户中心](https://order.shadowsocks.ch),执行下列操作：
